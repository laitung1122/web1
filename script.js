...
const GOOGLE_API_KEY = "AIzaSyCuRkJ9i2-RrhQdvSm0WddSSPLcxFrwNtw";
...
// Show typing effect with letter-by-letter animation
const showTypingEffect = (rawText, htmlText, messageElement, incomingMessageElement, skipEffect = false) => {
    ...
    const lettersArray = [...rawText]; // Split into individual characters
    let letterIndex = 0;

    const typingInterval = setInterval(() => {
        messageElement.innerText += lettersArray[letterIndex++];
    ...
    }, 5); // Adjust the speed here (lower value = faster typing)
};
